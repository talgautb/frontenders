...
Фанатик [«Дизайна в браузере»](http://habrahabr.ru/post/238485/). Дизайню интерфейсы, используя мощь фронт-энд технологий. Основной вектор это выстраивание процессов и среды для создания масштабируемых интерфейсов.

[блог](http://koloskov.ru/), [@koloskof](https://twitter.com/koloskof), [facebook](https://www.facebook.com/koloskov.kz), [linledIn](https://ru.linkedin.com/in/koloskof), [angelList](https://angel.co/koloskov-kz)
...
Разработчик интерфейсов, веду блог, перевожу статью для [Frontender Magazine](http://frontender.info/), планирую записывать обучающие материалы. Сделал удобный [автопрефиксер онлайн](http://autoprefixer.github.io). Хочу написать статью на хабр, выступить на front end конференции и стать консультантом по фронтэнду.

[Блог разработчика интерфейсов](http://ymatuhin.ru/), [@ymatuhin](https://twitter.com/ymatuhin), [github](http://github.com/ymatuhin)
